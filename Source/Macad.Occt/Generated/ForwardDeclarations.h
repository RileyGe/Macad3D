...
namespace Occt
{
	...
	ref class TopAbs;
	ref class GC_Root;
	ref class GC_MakeArcOfCircle;
	ref class GC_MakeArcOfEllipse;
	ref class GC_MakeArcOfHyperbola;
	ref class GC_MakeArcOfParabola;
	ref class GC_MakeCircle;
	ref class GC_MakeConicalSurface;
	ref class GC_MakeCylindricalSurface;
	ref class GC_MakeEllipse;
	ref class GC_MakeHyperbola;
	ref class GC_MakeLine;
	ref class GC_MakeMirror;
	ref class GC_MakePlane;
	ref class GC_MakeRotation;
	ref class GC_MakeScale;
	ref class GC_MakeSegment;
	ref class GC_MakeTranslation;
	ref class GC_MakeTrimmedCone;
	ref class GC_MakeTrimmedCylinder;
	ref class GCE2d_Root;
	ref class GCE2d_MakeArcOfCircle;
	ref class GCE2d_MakeArcOfEllipse;
	ref class GCE2d_MakeArcOfHyperbola;
	ref class GCE2d_MakeArcOfParabola;
	ref class GCE2d_MakeCircle;
	ref class GCE2d_MakeEllipse;
	ref class GCE2d_MakeHyperbola;
	ref class GCE2d_MakeLine;
	ref class GCE2d_MakeMirror;
	ref class GCE2d_MakeParabola;
	ref class GCE2d_MakeRotation;
	ref class GCE2d_MakeScale;
	ref class GCE2d_MakeSegment;
	ref class GCE2d_MakeTranslation;
